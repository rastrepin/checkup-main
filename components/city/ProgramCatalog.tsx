...
const MICRO: Record<GenderKey, Record<AgeKey, string>> = {
  ...
  male: {
    ...
    '40-50': 'Уролог, скринінг судин (дуплекс), ліпідограма, онкоскринінг кишечника, щитовидна залоза',
    'від 50': 'Ехокардіографія, скринінг судин (дуплекс), уролог, онкоскринінг кишечника, метаболічний контроль',
  },
};
