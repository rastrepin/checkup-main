    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Перше вимірювання холестерину роблять у 20 років. Якщо показники в нормі, його повторюють раз на 4–6 років<S n={[2]} />.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Простата: аналіз PSA</h3>
          <p className={P}>Рутинно аналіз PSA в цьому віці не пропонують: USPSTF говорить про нього для чоловіків 55–69 років<S n={[3]} />, урологи Mayo Clinic – з 50 років<S n={[2]} />. І тоді це спільне рішення з лікарем, а не автоматичний аналіз.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Якщо індекс маси тіла 25 або більше, з 35 років додають скринінг переддіабету і діабету 2 типу раз на 3 роки<S n={[4]} />.</p>
        </Section>
