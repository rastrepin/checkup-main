...
export const metadata: Metadata = {
  title: 'Чекап для чоловіків до 30 років у Харкові — від 3 820 грн',
  description: 'Комплексне обстеження для чоловіків до 30: серцево-судинна система, печінка, нирки, розширений інфекційний скринінг. Від 3 820 грн в ОН Клінік Харків.',
  alternates: {
...
const FAQ = [
  { q: 'Чому є тест на сифіліс?', a: 'Чоловіки до 30 років входять до групи підвищеного ризику. Аналіз RPR — швидкий скринінг, результат за 1 день.' },
  { q: 'Чому немає уролога?', a: 'Уролог включається в програму з 40 років. При скаргах — лікар направить раніше.' },
  { q: 'Чим відрізняється від 30-40?', a: 'Після 30 додається ліпідограма та УЗД органів черевної порожнини і нирок. Прибирається тест на сифіліс.' },
  { q: 'Як часто?', a: 'Раз на 2-3 роки.' },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'До 30 років', item: 'https://check-up.in.ua/ukr/male-checkup/do-30-rokiv/kharkiv' },
  ],
};
...
export default async function CatalogPage() {
  ...
  const minPrice = standard[0]?.price_discount ?? 3820;
      ...
      <main className="max-w-3xl mx-auto px-4 pt-6 pb-24">
        ...
        <section className="mb-8">
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            {'Для чоловіків 18-30 років. Базова діагностика: серцево-судинна система, печінка, нирки, інфекційний скринінг (включаючи сифіліс — через підвищений ризик у цій віковій групі).'}
          </p>
          <p className="text-sm text-gray-700 leading-relaxed">
            {'Підходить, якщо ви ведете активний спосіб життя, хочете знати базові показники, маєте спадковість, давно не обстежувалися.'}
          </p>
        </section>
          ...
          <div className="space-y-3">
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Серцево-судинна система'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">ЕКГ виявляє приховані порушення ритму — важливо для чоловіків з фізичними навантаженнями. Холестерин — базова лінія.</p>
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              ...
              <ul className="space-y-0.5">
                  ...
                  <li className="text-xs text-gray-700 flex gap-1.5"><span className="text-gray-400 shrink-0">—</span><span>{'Тест на сифіліс (RPR)'}</span></li>
              ...
              {standard.map(p => {
                ...
                return (
                  <div key={p.id} className="border-[1.5px] border-[#005485] rounded-xl p-5 mb-3">
                    ...
                    <p className="text-[13px] text-gray-500 mb-3">{'Терапевт · 2 візити · 11 аналізів · ЕКГ, тест на сифіліс'}</p>
                    ...
                    <Link href="/ukr/male-checkup/first-checkup-under-30" className="block text-center text-[13px] text-[#005485] hover:underline">
        ...
        <section className="mb-10 bg-gray-50 rounded-xl p-5">
          ...
          <ul className="space-y-1.5 text-sm text-gray-700">
            ...
            <li>{'Візьміть: паспорт, попередні результати'}</li>
          </ul>
        </section>
        ...
        <section className="mb-8 text-sm text-gray-600 bg-gray-50 rounded-xl p-5">
          <p>
            {`Чекап для чоловіків до 30 років у Харкові проводиться в мережі «ОН Клінік» за трьома адресами: вул. Ярослава Мудрого, 30а; пр. Героїв Харкова, 257; вул. Молочна, 48. Стандартна програма — від 3 820 грн, розширена «Чоловічий профілактичний» — 7 722 грн. Ціни перевірено: квітень 2026.`}
          </p>
        </section>
        ...
        <nav className="text-sm">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/ukr/male-checkup/40-50-rokiv/kharkiv" className="px-3 py-1.5 border border-gray-200 rounded-full text-gray-700 hover:border-[#005485] transition-colors text-xs">{'40–50 років'}</Link>
