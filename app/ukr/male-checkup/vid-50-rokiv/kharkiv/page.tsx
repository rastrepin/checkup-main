...
export const metadata: Metadata = {
  title: 'Чекап для чоловіків від 50 років у Харкові — від 7 580 грн',
  description: 'Найповніша чоловіча програма: ехокардіографія, дуплекс судин, уролог, скринінг колоректального раку. Від 7 580 грн в ОН Клінік Харків.',
  alternates: {
...
const FAQ = [
  { q: 'Чим відрізняється від 40-50?', a: 'Додано ехокардіографію (УЗД серця). Найповніша чоловіча програма — повна кардіодіагностика.' },
  { q: 'Чи входить ПСА?', a: 'Не входить у стандартну програму. Уролог за потреби призначає індивідуально.' },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Від 50 років', item: 'https://check-up.in.ua/ukr/male-checkup/vid-50-rokiv/kharkiv' },
  ],
};
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 pt-6 pb-24">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 leading-tight">
          Чекап для чоловіків від 50 років у Харкові
        </h1>
        ...
        <section className="mb-8">
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            {'Для чоловіків від 50 років. Найповніша чоловіча програма. Порівняно з 40-50: додано ехокардіографію (УЗД серця). Повна кардіодіагностика: ЕКГ + ехокардіографія + дуплекс судин.'}
          </p>
          <p className="text-sm text-gray-700 leading-relaxed">
            {'Повна діагностика: кардіо з ехокардіографією та дуплексом, консультація уролога, онкоскринінг кишечника, внутрішні органи.'}
          </p>
        </section>
          ...
          <div className="space-y-3">
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Серцево-судинна система'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">Після 50 ризик інфаркту та інсульту найвищий. Ехокардіографія оцінює структуру та функцію серця, дуплекс — стан судин.</p>
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Чоловіче здоров\'я (уролог)'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">Після 50 ризики захворювань сечостатевої системи зростають. Уролог оцінює результати та за потреби призначає додаткові дослідження.</p>
              <ul className="space-y-0.5">
              ...
              {standard.map(p => {
                ...
                return (
                  <div key={p.id} className="border-[1.5px] border-[#005485] rounded-xl p-5 mb-3">
                    ...
                    <p className="text-[13px] text-gray-500 mb-3">{'Терапевт, уролог · 2 візити · 11 аналізів · Ехокардіографія, дуплекс судин'}</p>
                    ...
                    <Link href="/ukr/male-checkup/first-checkup-over-50" className="block text-center text-[13px] text-[#005485] hover:underline">
        ...
        <section className="mb-8 text-sm text-gray-600 bg-gray-50 rounded-xl p-5">
          <p>
            {`Чекап для чоловіків від 50 років у Харкові проводиться в мережі «ОН Клінік» за трьома адресами: вул. Ярослава Мудрого, 30а; пр. Героїв Харкова, 257; вул. Молочна, 48. Стандартна програма — від 7 580 грн, розширена «Чоловічий після 40» — 15 386 грн. Ціни перевірено: квітень 2026.`}
          </p>
        </section>
