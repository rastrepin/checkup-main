...
export const metadata: Metadata = {
  title: 'Чекап для чоловіків від 50 років у Харкові 2026 | check-up.in.ua',
  description: 'Комплексне обстеження для чоловіків від 50 років у Харкові: серце, судини, простата, онкологія. ОН Клінік Харків.',
  alternates: {
    ...
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-4 max-w-xl">Комплексне обстеження для чоловіків від 50 років у Харкові: серце, судини, простата, онкологія. ОН Клінік Харків.</p>
        </div>
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>Після 50 років чоловічий чек-ап охоплює розгорнуту кардіологічну оцінку, скринінг раку простати (ПСА + УЗД), аналіз на онкомаркери та денситометрію.</p>
          <p>Повторюваність обстеження — раз на 6 місяців — дозволяє відстежувати динаміку показників і своєчасно коригувати лікування.</p>
        </section>
