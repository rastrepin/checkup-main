...
export const metadata: Metadata = {
  title: 'Чекап для чоловіків 30-40 років у Харкові — від 5 020 грн',
  description: 'Комплексне обстеження для чоловіків 30-40: ліпідограма, УЗД черевної порожнини та нирок, серцево-судинна система. Від 5 020 грн в ОН Клінік Харків.',
  alternates: {
    canonical: 'https://check-up.in.ua/ukr/male-checkup/30-40-rokiv/kharkiv',
  },
};
...
const FAQ = [
  { q: 'Чим відрізняється від до 30?', a: 'Додано ліпідограму, УЗД органів черевної порожнини та нирок. Прибрано тест на сифіліс.' },
  { q: 'Як часто?', a: 'Раз на 1-2 роки.' },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: '30–40 років', item: 'https://check-up.in.ua/ukr/male-checkup/30-40-rokiv/kharkiv' },
  ],
};
...
export default async function CatalogPage() {
  ...
  const minPrice = standard[0]?.price_discount ?? 5020;
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 pt-6 pb-24">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 leading-tight">
          Чекап для чоловіків 30-40 років у Харкові
        </h1>
        ...
        <section className="mb-8">
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            {'Для чоловіків 30-40 років. Порівняно з «до 30»: ліпідограма замість загального холестерину, додано УЗД органів черевної порожнини та нирок.'}
          </p>
          <p className="text-sm text-gray-700 leading-relaxed">
            {'Розширена діагностика. Ліпідограма точніше оцінює ризики, УЗД черевної порожнини виявляє зміни внутрішніх органів на безсимптомній стадії.'}
          </p>
        </section>
          ...
          <div className="space-y-3">
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Серцево-судинна система'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">Ліпідограма показує баланс ЛПВЩ та ЛПНЩ. Чоловіки 30-40 з надлишковою вагою та стресом — група ризику.</p>
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Шлунково-кишковий тракт та внутрішні органи'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">УЗД черевної порожнини — оцінка печінки, жовчного, підшлункової. Жирова дистрофія — часта знахідка.</p>
              <ul className="space-y-0.5">
              ...
              {standard.map(p => {
                ...
                return (
                  <div key={p.id} className="border-[1.5px] border-[#005485] rounded-xl p-5 mb-3">
                    ...
                    <p className="text-[13px] text-gray-500 mb-3">{'Терапевт · 2 візити · 10 аналізів · УЗД черевної порожнини, нирок'}</p>
                    ...
                    <Link href="/ukr/male-checkup/first-checkup-30-40" className="block text-center text-[13px] text-[#005485] hover:underline">
        ...
        <section className="mb-8 text-sm text-gray-600 bg-gray-50 rounded-xl p-5">
          <p>
            {`Чекап для чоловіків 30-40 років у Харкові проводиться в мережі «ОН Клінік» за трьома адресами: вул. Ярослава Мудрого, 30а; пр. Героїв Харкова, 257; вул. Молочна, 48. Стандартна програма — від 5 020 грн, розширена «Чоловічий профілактичний» — 7 722 грн. Ціни перевірено: квітень 2026.`}
          </p>
        </section>
