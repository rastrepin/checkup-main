...
const SOURCE_CTA = 'age_page_male_30_40_kharkiv';
// SEO-STANDARD р.4, Тип 5a. X (мінімальна ціна програм клініки для сторінки) – з Supabase у generateMetadata.
const TITLE = "Чекап для чоловіків 30–40 років: які обстеження проходити, програми в Харкові | check-up.in.ua";
const DESCRIPTION_BASE = "Які обстеження потрібні чоловікам 30–40 років. 4 цілі скринінгу.";
...
const FAQ: { q: string; a: string }[] = [
  { q: "Чи змінюється щось у переліку після 35?", a: "Так. З 35 років чоловікам із надлишковою вагою або ожирінням додають скринінг переддіабету і діабету 2 типу раз на 3 роки. За нормальної ваги рутинна перевірка не потрібна, якщо лікар не бачить інших підстав." },
  ...
  { q: "Чи потрібен аналіз PSA в цьому віці?", a: "Без скарг рутинно його не пропонують. USPSTF говорить про аналіз PSA для чоловіків 55–69 років, урологи Mayo Clinic – з 50 років, і в обох випадках це спільне рішення з лікарем. Докладніше – на сторінці про аналіз PSA." },
...
export default async function MaleAge3040KharkivPage() {
  ...
  const jsonLd: object[] = [
    {
      ...
      '@type': 'MedicalWebPage',
      name: "Чекап для чоловіків 30–40 років – що перевіряти і де пройти в Харкові",
      url: PAGE_URL,
    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <section style={{ backgroundColor: BG_GRAY }}>
          <div className="max-w-[1200px] mx-auto px-6 lg:px-14 py-14">
            <div className="max-w-3xl">
              ...
              >
                Чекап для чоловіків 30–40 років – що перевіряти і де пройти в Харкові
              </h1>
              <p className="text-lg text-gray-700 leading-relaxed mt-2">Сторінка для чоловіків 30–40 років без скарг. Спочатку перелік за клінічними настановами, потім готова програма клініки в Харкові.</p>
            </div>
          </div>
        </section>
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Між 30 і 40 з&apos;являються перші перевірки, які залежать не лише від віку, а й від ваги.</p>
          <p className={P}>Єдиного українського протоколу профілактичного обстеження для цього віку немає. Тому перелік нижче складений за українськими порядками скринінгу окремих хвороб і за міжнародними рекомендаціями.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Артеріальний тиск</h3>
          <p className={P}>До 40 років тиск вимірюють раз на 3–5 років, а за наявності факторів ризику – щороку<S n={[1]} />. Це вимірювання на прийомі, окремого аналізу для нього не потрібно.</p>
          ...
          <p className={P}>З 35 років людям із надлишковою вагою або ожирінням, тобто з індексом маси тіла 25 і більше, рекомендують скринінг переддіабету і діабету 2 типу раз на 3 роки<S n={[2]} />. Показанням є поєднання віку і ваги: за нормальної ваги рутинна перевірка не потрібна, якщо лікар не бачить інших підстав.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Простата: аналіз PSA</h3>
          <p className={P}>Рутинно аналіз PSA в цьому віці не пропонують: USPSTF говорить про нього для чоловіків 55–69 років<S n={[3]} />, урологи Mayo Clinic – з 50 років<S n={[1]} />. І тоді це спільне рішення з лікарем, а не автоматичний аналіз.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Тиск вимірюють щороку, а не раз на 3–5 років<S n={[1]} />. Які фактори ризику є саме у вас, оцінює лікар.</p>
        </Section>
          ...
          <section style={{ backgroundColor: BG_WHITE, borderTop: BORDER }}>
            <div className="max-w-[1200px] mx-auto px-6 lg:px-14 py-10">
              <div className="max-w-3xl text-[14px] text-gray-600 leading-relaxed">
                <p>
                  Чекап для чоловіків 30–40 років у Харкові можна пройти в {clinic.name}: {branches.length}{' '}
