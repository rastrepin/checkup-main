    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>До 40 років тиск вимірюють раз на 3–5 років, а за наявності факторів ризику – щороку<S n={[2]} />. Це вимірювання на прийомі, окремого аналізу для нього не потрібно.</p>
          ...
          <p className={P}>З 35 років людям із надлишковою вагою або ожирінням, тобто з індексом маси тіла 25 і більше, рекомендують скринінг переддіабету і діабету 2 типу раз на 3 роки<S n={[3]} />. Показанням є поєднання віку і ваги: за нормальної ваги рутинна перевірка не потрібна, якщо лікар не бачить інших підстав.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Простата: аналіз PSA</h3>
          <p className={P}>Рутинно аналіз PSA в цьому віці не пропонують: USPSTF говорить про нього для чоловіків 55–69 років<S n={[4]} />, урологи Mayo Clinic – з 50 років<S n={[2]} />. І тоді це спільне рішення з лікарем, а не автоматичний аналіз.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Тиск вимірюють щороку, а не раз на 3–5 років<S n={[2]} />. Які фактори ризику є саме у вас, оцінює лікар.</p>
        </Section>
