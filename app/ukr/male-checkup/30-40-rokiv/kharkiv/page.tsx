    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Рутинно аналіз PSA в цьому віці не пропонують: USPSTF говорить про нього для чоловіків 55–69 років<S n={[5]} />, урологи Mayo Clinic – з 50 років<S n={[3]} />. І тоді це спільне рішення з лікарем, а не автоматичний аналіз.</p>
