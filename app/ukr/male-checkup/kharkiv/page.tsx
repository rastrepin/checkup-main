...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Диспансеризацію скасовано 2018 року. Скринінг колоректального раку описує окремий порядок МОЗ. Державного скринінгу раку передміхурової залози немає.",
  },
  {
      ...
      <main className="text-[#0b1a24]">
        ...
        <Section bg={BG_GRAY} eyebrow="За клінічними настановами">
          ...
          <p className={P}>
            ...
            тест калу на приховану кров щороку з 40 років<S n={[4]} />.
          </p>
          ...
          <p className={P}>
            З 50 років тест калу на приховану кров або фекальний імунохімічний тест роблять раз на 2 роки<S n={[4]} />.
            Аналіз PSA – не автоматичний пункт, а спільне рішення з лікарем: USPSTF пропонує його у 55–69 років
            <S n={[5]} />, урологи Mayo Clinic – щороку з 50 років<S n={[2]} />.
          </p>
          <AgeLinks
            links={[
