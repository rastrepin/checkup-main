    ...
    <main className="text-[#0b1a24]">
      ...
      <Section bg={BG_WHITE} eyebrow="Суть обстеження">
        ...
        <p className={P}>
          ...
          МОЗ для скринінгу раку передміхурової залози теж немає; українською доступна адаптована настанова
          Duodecim<S n={[4]} />.
        </p>
      </Section>
      ...
      <Section bg={BG_GRAY} eyebrow="Межі методу">
        ...
        <p className={P}>
          Головна проблема скринінгу PSA – він знаходить і такі форми раку, які за життя не спричинили б проблем.
          Через це частина чоловіків проходить операцію або опромінення, які їм не були потрібні<S n={[2, 3]} />.
        </p>
        <p className={P}>
      ...
      <Section bg={BG_WHITE} eyebrow="Вік і рішення">
        ...
        <p className={P}>
          USPSTF пропонує чоловікам 55–69 років вирішувати щодо аналізу PSA індивідуально, разом з лікарем<S n={[2]} />.
        </p>
        <p className={P}>
