...
const ADDITIONS: AgeAddition[] = [
  ...
  { id: "mammo", name: "Мамографія", keywords: ["мамограф"], explanation: "У 50–69 років кожні 2 роки для всіх жінок.", why: <>У 50–69 років її роблять кожні 2 роки всім жінкам. УЗД молочних залоз не замінює мамографію: для скринінгу раку молочної залози після 50 років використовують саме мамографію<S n={[1]} />. Лікар може призначити УЗД додатково, якщо тканина молочних залоз щільна або потрібно уточнити зміни, знайдені на мамограмі: наприклад, відрізнити кісту від пухлини<S n={[7]} />.</>, forAll: true, missingName: "мамографія" },
    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Державна програма «Скринінг здоров&apos;я 40+» передбачає перевірку рівня цукру в крові для всіх від 40 років, незалежно від маси тіла<S n={[3]} />.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Графік скринінгу інший: ПАП-тест або тест на ВПЛ роблять кожні 5 років<S n={[1]} />, і з віком скринінг не припиняють<S n={[4]} />.</p>
        </Section>
