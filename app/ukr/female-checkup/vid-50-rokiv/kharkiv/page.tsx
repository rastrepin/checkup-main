...
const TITLE = "Чекап для жінок після 50 років у Харкові: що перевіряти | check-up.in.ua";
const DESCRIPTION = "Що перевіряти жінці після 50 років за клінічними настановами: мамографія, скринінг колоректального раку, ПАП-тест до 65, денситометрія з 65. Готова програма клініки в Харкові.";
  ...
  const jsonLd: object[] = [
    {
      ...
      '@type': 'MedicalWebPage',
      name: "Чекап для жінок після 50 років у Харкові",
      url: PAGE_URL,
