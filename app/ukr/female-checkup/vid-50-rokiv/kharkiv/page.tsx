...
export const metadata: Metadata = {
  title: 'Чекап для жінок від 50 років у Харкові 2026 | check-up.in.ua',
  description: 'Комплексне обстеження для жінок від 50 років у Харкові: серце, кістки, онкологія, гормони в постменопаузі. ОН Клінік.',
  alternates: {
    ...
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex flex-wrap gap-1 items-center">
          ...
          <span>→</span>
          <span className="text-gray-600">Від 50 років</span>
        </nav>
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-4 max-w-xl">Комплексне обстеження для жінок від 50 років у Харкові: серце, кістки, онкологія, гормони в постменопаузі. ОН Клінік.</p>
        </div>
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>Після 50 років пріоритет — кардіологічний та онкологічний скринінг, оцінка щільності кісток (денситометрія) та контроль артеріального тиску.</p>
          <p>Гормональний профіль у постменопаузі, ліпідний профіль та аналіз на глюкозу дозволяють вчасно корегувати метаболічні ризики.</p>
        </section>
