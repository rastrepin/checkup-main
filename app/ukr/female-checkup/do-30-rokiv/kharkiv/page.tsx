...
const TITLE = "Чекап для жінок до 30 років у Харкові: що перевіряти | check-up.in.ua";
const DESCRIPTION = "Що перевіряти жінці до 30 років за клінічними настановами: ПАП-тест, тиск, холестерин. Готова програма клініки в Харкові і що до неї додати.";
  ...
  const jsonLd: object[] = [
    {
      ...
      '@type': 'MedicalWebPage',
      name: "Чекап для жінок до 30 років у Харкові",
      url: PAGE_URL,
    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>За стандартом МОЗ мазок на клітини можна робити з 21 року, раз на 3 роки<S n={[3]} />. Порядок скринінгу називає популяційний вік 25–65 років<S n={[4]} />. Коли починати саме вам, обговоріть з гінекологом.</p>
          ...
          <p className={P}>До 40 років тиск вимірюють раз на 3–5 років, а за наявності факторів ризику – щороку<S n={[5]} />. Це вимірювання на прийомі, окремого аналізу для нього не потрібно.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Холестерин</h3>
          <p className={P}>Перше вимірювання холестерину роблять у 20 років. Якщо показники в нормі, його повторюють раз на 4–6 років<S n={[5]} />.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Молочні залози</h3>
          <p className={P}>Якщо вам менше 40 і немає скарг чи раку молочної залози в родині, мамографія найімовірніше не потрібна<S n={[5]} />. Вона стає потрібною раніше, якщо рак був у матері, сестри або доньки: про це в наступному блоці.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Мамографію починають за 5–10 років до віку, у якому діагноз поставили родичці<S n={[5]} />. З якого віку починати вам, обговоріть з лікарем.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Фактори серцево-судинного ризику</h3>
          <p className={P}>Тиск вимірюють щороку, а не раз на 3–5 років<S n={[5]} />. Які фактори ризику є саме у вас, оцінює лікар.</p>
          <h3 className="text-lg font-semibold text-[#0b1a24] mt-8">Надлишкова вага</h3>
          <p className={P}>Якщо індекс маси тіла 25 або більше, з 35 років додають скринінг переддіабету і діабету 2 типу раз на 3 роки<S n={[6]} />.</p>
