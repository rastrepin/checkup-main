...
export const metadata: Metadata = {
  title: 'Чекап для жінок до 30 років у Харкові 2026 | check-up.in.ua',
  description: 'Базове обстеження для жінок до 30 років у Харкові: ОАК, гормони, УЗД органів малого тазу, консультація гінеколога. ОН Клінік.',
  alternates: {
    ...
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-4 max-w-xl">Базове обстеження для жінок до 30 років у Харкові: ОАК, гормони, УЗД органів малого тазу, консультація гінеколога. ОН Клінік.</p>
        </div>
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>У молодому віці важливо встановити базовий стан здоров'я: загальний аналіз крові, ТТГ, рівень феритину, УЗД органів малого тазу.</p>
          <p>Програма рекомендована для жінок, які ще не мають хронічних захворювань, але хочуть контролювати репродуктивне здоров'я та рівень мікроелементів.</p>
        </section>
