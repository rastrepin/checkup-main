    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Мазок на клітини шийки матки (ПАП-тест) роблять раз на 3 роки або тест на вірус папіломи людини (ВПЛ) раз на 5–10 років: спосіб та інтервал ви обираєте разом із гінекологом<S n={[4]} />. Державний порядок скринінгу передбачає мінімум: тест раз на 10 років до 55 років<S n={[5]} />. Детальніше на сторінці «<Link href="/ukr/screening/pap-test" className="text-[#005485] underline hover:no-underline">ПАП-тест: що показує і коли потрібен</Link>».</p>
