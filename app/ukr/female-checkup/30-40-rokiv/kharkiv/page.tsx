...
export const metadata: Metadata = {
  title: 'Чекап для жінок 30-40 років у Харкові — від 7 580 грн',
  description: 'Комплексне обстеження для жінок 30-40: ліпідограма, УЗД органів черевної порожнини та нирок, онкоскринінг. Від 7 580 грн в ОН Клінік Харків.',
  alternates: {
...
const FAQ = [
  { q: 'Чим відрізняється від програми до 30?', a: 'Додано УЗД органів черевної порожнини та нирок, ліпідограму замість загального холестерину. Це дає точнішу оцінку ризиків, які зростають після 30.' },
  { q: 'Чи включена оцінка фертильності?', a: 'Базова оцінка (ТТГ, гінеколог) включена. Для детального обстеження фертильності (ФСГ, АМГ) лікар може рекомендувати окрему програму.' },
  { q: 'Як часто проходити?', a: 'Раз на 1-2 роки. Між повними — регулярна щорічно.' },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: '30–40 років', item: 'https://check-up.in.ua/ukr/female-checkup/30-40-rokiv/kharkiv' },
  ],
};
...
export default async function CatalogPage() {
  ...
  const minPrice = standard[0]?.price_discount ?? 7580;
      ...
      <main className="max-w-3xl mx-auto px-4 pt-6 pb-24">
        ...
        <section className="mb-8">
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            {'Для жінок 30-40 років. В цьому віці зростають ризики гормональних порушень та серцево-судинних захворювань. Програма розширена порівняно з «до 30»: ліпідограма замість загального холестерину, додано УЗД органів черевної порожнини та нирок.'}
          </p>
          <p className="text-sm text-gray-700 leading-relaxed">
            {'Програма підходить, якщо ви відчуваєте втому, зміни настрою або ваги без очевидної причини; маєте нерегулярний цикл; хочете перевірити серцево-судинні ризики; не проходили обстеження більше 2 років.'}
          </p>
        </section>
        ...
        <section className="mb-8 bg-gray-50 rounded-xl p-5">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            ...
            <div className="flex gap-2 font-medium text-[#005485]">
              <span className="shrink-0">30-40 років ←</span>
          ...
          <div className="space-y-3">
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Репродуктивна система та молочні залози'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">Після 30 ризик захворювань молочних залоз зростає. ПАП-тест залишається обов'язковим.</p>
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Серцево-судинна система'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">Ліпідограма показує баланс ЛПВЩ та ЛПНЩ — точніше за загальний холестерин.</p>
              <ul className="space-y-0.5">
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Ендокринна система'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">У жінок 30-40 порушення щитовидної залози трапляються частіше — впливає на фертильність, енергію, вагу.</p>
              <ul className="space-y-0.5">
            ...
            <div className="border border-gray-200 rounded-xl p-4">
              <h3 className="text-sm font-bold text-gray-900 mb-1">{'Шлунково-кишковий тракт та внутрішні органи'}</h3>
                <p className="text-xs text-gray-500 mb-2 leading-relaxed">УЗД черевної порожнини оцінює печінку, жовчний міхур, підшлункову залозу. Виявляє зміни на безсимптомній стадії.</p>
              <ul className="space-y-0.5">
              ...
              {standard.map(p => {
                ...
                return (
                  <div key={p.id} className="border-[1.5px] border-[#005485] rounded-xl p-5 mb-3">
                    ...
                    <p className="text-[13px] text-gray-500 mb-3">{'Терапевт, гінеколог · 2 візити · 12 аналізів · УЗД черевної порожнини, нирок, малого тазу'}</p>
                    ...
                    <Link href="/ukr/female-checkup/first-checkup-30-40" className="block text-center text-[13px] text-[#005485] hover:underline">
        ...
        <section className="mb-10 bg-gray-50 rounded-xl p-5">
          ...
          <ul className="space-y-1.5 text-sm text-gray-700">
            ...
            <li>{'Виключіть продукти що викликають метеоризм (для УЗД черевної порожнини)'}</li>
        ...
        <section className="mb-8 text-sm text-gray-600 bg-gray-50 rounded-xl p-5">
          <p>
            {`Чекап для жінок 30-40 років у Харкові проводиться в мережі «ОН Клінік» за трьома адресами: вул. Ярослава Мудрого, 30а; пр. Героїв Харкова, 257; вул. Молочна, 48. Стандартна програма — від 7 580 грн, розширена «Жіночий профілактичний» — 11 724 грн. Ціни перевірено: квітень 2026.`}
          </p>
        </section>
