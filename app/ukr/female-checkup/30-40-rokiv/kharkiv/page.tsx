...
export const metadata: Metadata = {
  title: 'Чекап для жінок 30–40 років у Харкові 2026 | check-up.in.ua',
  description: 'Комплексне обстеження для жінок 30–40 років у Харкові: гормональний профіль, онкомаркери, кардіологічний скринінг. ОН Клінік.',
  alternates: {
    ...
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <nav className="text-xs text-gray-400 mb-6 flex flex-wrap gap-1 items-center">
          ...
          <span>→</span>
          <Link href="/ukr/female-checkup/kharkiv" className="hover:text-[#005485]">Чекап для жінок</Link>
          <span>→</span>
          <span className="text-gray-600">30–40 років</span>
        </nav>
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-4 max-w-xl">Комплексне обстеження для жінок 30–40 років у Харкові: гормональний профіль, онкомаркери, кардіологічний скринінг. ОН Клінік.</p>
        </div>
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>У 30–40 років до базового скринінгу додається гормональний профіль (естрадіол, прогестерон, ФСГ), перша оцінка ризиків серцево-судинних захворювань та онкомаркери.</p>
          <p>Обстеження займає один візит і дозволяє виявити ранні зміни в гормональному фоні до появи симптомів.</p>
        </section>
