...
/* Джерела: [n] у тексті → пункт n (задача v1 для 30–40, розділ 10). */
...
/* Картка з відповіддю: три обстеження для всіх у 30–40 років (назви – ті самі, що в мості блоку 4). */
 ...
 * forAll – рекомендоване у 30–40 років усім; лише такі входять у {missingTests}. Холестерин стоїть у картці
 * з відповіддю серед обстежень для всіх, тому тут forAll = true (задача v1 для 30–40, розділ 6): якщо його немає
 * в програмі, другий рядок мосту блоку 4 його називає. */
            ...
            <div className="max-w-3xl">
              ...
              <div className="bg-white border-[1.5px] border-[#e5e7eb] rounded-[12px] px-4 pt-4 pb-3 mb-4">
                ...
                <p className="text-[15px] text-[#374151] mt-2">
                  З 35 років до них додається{' '}
                  <a href={`#${ID.diabetes}`} className={LINK}>
                    аналіз на цукор у крові
                  </a>
                  <S n={[6]} />. Якщо рак молочної залози був у матері, сестри або доньки,{' '}
        ...
        <div className="max-w-[1200px] mx-auto lg:px-14 lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-x-12">
          ...
          <div className="lg:col-start-1 lg:row-start-1 min-w-0">
            ...
            <Block eyebrow="Ваша історія" id={ID.history}>
              ...
              <p className={P}>Графік скринінгу інший: ПАП-тест або тест на ВПЛ роблять кожні 5 років<S n={[5]} />, і з віком скринінг не припиняють<S n={[2]} />.</p>
