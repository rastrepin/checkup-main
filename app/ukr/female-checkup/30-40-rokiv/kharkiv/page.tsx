    ...
    <>
      <main className="text-[#0b1a24] pb-24 md:pb-0">
        ...
        <Section bg={BG_WHITE} eyebrow="За клінічними настановами">
          ...
          <p className={P}>Мазок на клітини роблять раз на 3 роки<S n={[1]} />. З 35 років стандарт МОЗ допускає інший спосіб – тест на вірус папіломи людини (ВПЛ) раз на 10 років<S n={[1]} />. Який підходить вам, обговоріть з гінекологом.</p>
          ...
          <p className={P}>Якщо вам менше 40 і немає скарг чи раку молочної залози в родині, мамографія найімовірніше не потрібна<S n={[2]} />. Вона стає потрібною раніше, якщо рак був у матері, сестри або доньки: про це в наступному блоці.</p>
        ...
        <Section bg={BG_GRAY} eyebrow="Ваша історія">
          ...
          <p className={P}>Мамографію починають за 5–10 років до віку, у якому діагноз поставили родичці<S n={[2]} />. З якого віку починати вам, обговоріть з лікарем.</p>
          ...
          <p className={P}>Графік ПАП-тесту інший: після першого нормального мазка наступний роблять через 12 місяців, а скринінг з віком не припиняють<S n={[1]} />.</p>
        </Section>
