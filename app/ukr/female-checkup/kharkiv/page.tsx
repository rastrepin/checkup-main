...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Диспансеризацію скасовано 2018 року. Скринінг раку молочної залози, шийки матки і колоректального раку описують окремі порядки МОЗ.",
  },
  {
      ...
      <main className="text-[#0b1a24]">
        ...
        <Section bg={BG_GRAY} eyebrow="За клінічними настановами">
          ...
          <p className={P}>
            ...
            2 роки<S n={[5]} />. З 65 років додається денситометрія – вимірювання щільності кісток<S n={[6]} />.
          </p>
          <AgeLinks
            links={[
