...
export const metadata: Metadata = {
  title: 'Чекап для мужчин до 30 лет в Харькове 2026 | check-up.in.ua',
  description: 'Базовое обследование для мужчин до 30 лет в Харькове: ОАК, глюкоза, ЭКГ, консультация уролога. ОН Клиник Харьков.',
  alternates: {
  ...
  return (
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#0b1a24] mb-3 h1-teal-line">Чекап для мужчин до 30 лет в Харькове</h1>
          <p className="text-gray-500 mt-4 max-w-xl">Базовое обследование для мужчин до 30 лет в Харькове: ОАК, глюкоза, ЭКГ, консультация уролога. ОН Клиник Харьков.</p>
        </div>
        {safe.length > 0 ? (
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>В молодом возрасте рекомендуется установить базовые показатели: ОАК, глюкоза, холестерин, ЭКГ и консультация уролога.</p>
          <p>Программа помогает выявить ранние метаболические нарушения и отклонения в работе сердца, даже при отсутствии симптомов.</p>
        </section>
