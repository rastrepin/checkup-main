...
export const metadata: Metadata = {
  title: 'Чекап для женщин от 50 лет в Харькове 2026 | check-up.in.ua',
  description: 'Комплексное обследование для женщин от 50 лет в Харькове: сердце, кости, онкология, гормоны в постменопаузе. ОН Клиник.',
  alternates: {
    canonical: 'https://check-up.in.ua/female-checkup/ot-50-let/kharkov',
    languages: {
      'ru': 'https://check-up.in.ua/female-checkup/ot-50-let/kharkov',
      'uk': 'https://check-up.in.ua/ukr/female-checkup/vid-50-rokiv/kharkiv',
    },
  },
};
  ...
  return (
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#0b1a24] mb-3 h1-teal-line">Чекап для женщин от 50 лет в Харькове</h1>
          <p className="text-gray-500 mt-4 max-w-xl">Комплексное обследование для женщин от 50 лет в Харькове: сердце, кости, онкология, гормоны в постменопаузе. ОН Клиник.</p>
        </div>
        {safe.length > 0 ? (
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>После 50 лет приоритет — кардиологический и онкологический скрининг, оценка плотности костей (денситометрия) и контроль артериального давления.</p>
          <p>Гормональный профиль в постменопаузе, липидный профиль и анализ на глюкозу позволяют вовремя корректировать метаболические риски.</p>
        </section>
