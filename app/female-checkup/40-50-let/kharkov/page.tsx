...
export const metadata: Metadata = {
  title: 'Чекап для женщин 40–50 лет в Харькове 2026 | check-up.in.ua',
  description: 'Расширенный чекап для женщин 40–50 лет в Харькове: климакс, онкологический скрининг, сердце, щитовидная железа. ОН Клиник.',
  alternates: {
    canonical: 'https://check-up.in.ua/female-checkup/40-50-let/kharkov',
    languages: {
      'ru': 'https://check-up.in.ua/female-checkup/40-50-let/kharkov',
      'uk': 'https://check-up.in.ua/ukr/female-checkup/40-50-rokiv/kharkiv',
    },
  },
};
...
export default async function Page() {
  const { data: programs } = await db()
    ...
    .in('age_group', ['40-50', 'after-40']).eq('is_specialized', false)
    ...
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <nav className="text-xs text-gray-400 mb-6 flex flex-wrap gap-1 items-center">
          ...
          <span className="text-gray-600">40–50 лет</span>
        </nav>
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#0b1a24] mb-3 h1-teal-line">Чекап для женщин 40–50 лет в Харькове</h1>
          <p className="text-gray-500 mt-4 max-w-xl">Расширенный чекап для женщин 40–50 лет в Харькове: климакс, онкологический скрининг, сердце, щитовидная железа. ОН Клиник.</p>
        </div>
        {safe.length > 0 ? (
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>Возраст 40–50 лет — время расширенного онкологического скрининга: маммография, CA 125, CA 15-3, цитология шейки матки.</p>
          <p>Также оценивается гормональный статус в контексте предклимакса: уровень ФСГ, эстрадиола, ТТГ, липидный профиль.</p>
        </section>
