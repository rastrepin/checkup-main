...
export const metadata: Metadata = {
  title: 'Чекап для женщин 30–40 лет в Харькове 2026 | check-up.in.ua',
  description: 'Комплексное обследование для женщин 30–40 лет в Харькове: гормональный профиль, онкомаркеры, кардиологический скрининг. ОН Клиник.',
  alternates: {
    canonical: 'https://check-up.in.ua/female-checkup/30-40-let/kharkov',
    languages: {
      'ru': 'https://check-up.in.ua/female-checkup/30-40-let/kharkov',
      'uk': 'https://check-up.in.ua/ukr/female-checkup/30-40-rokiv/kharkiv',
    },
  },
};
  ...
  return (
    <main className="bg-[#f9fbfd] min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#0b1a24] mb-3 h1-teal-line">Чекап для женщин 30–40 лет в Харькове</h1>
          <p className="text-gray-500 mt-4 max-w-xl">Комплексное обследование для женщин 30–40 лет в Харькове: гормональный профиль, онкомаркеры, кардиологический скрининг. ОН Клиник.</p>
        </div>
        {safe.length > 0 ? (
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 px-6 py-6 mb-10 text-sm text-gray-600 space-y-3">
          <p>В 30–40 лет к базовому скринингу добавляется гормональный профиль (эстрадиол, прогестерон, ФСГ) и первая оценка рисков сердечно-сосудистых заболеваний.</p>
          <p>Обследование проходит за один визит и позволяет выявить ранние изменения в гормональном фоне до появления симптомов.</p>
        </section>
